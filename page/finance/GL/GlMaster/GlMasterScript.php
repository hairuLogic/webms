<script>
		...
		$(document).ready(function () {
			...
			$("#jqGrid").jqGrid({
				url: 'GlMasterTbl.php',
				editurl: 'GlMasterSave.php',
				datatype: "json",
				 colModel: [
					{ label: 'No', name: 'sysno', width: 5, sorttype: 'number', hidden:true},
					{ label: 'compcode', name: 'compcode', width: 40, hidden:true},						
					{ label: 'Gl Account', name: 'glaccount', width: 20, classes: 'wrap', canSearch: true, checked:true},
			...
			function saveFormdata(oper){
				$.post( "GlMasterSave.php", $( "#formdata" ).serialize()+'&'+$.param({ 'oper': oper }) , function( data ) {
			...
			function search(Stext,Scol){
				$("#jqGrid").jqGrid('setGridParam',{datatype:'json',url:'GlMasterTbl.php?Scol='+Scol+'&Stext='+Stext}).trigger('reloadGrid');
			}
