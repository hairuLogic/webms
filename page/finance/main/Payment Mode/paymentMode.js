			...
			$("#jqGrid").jqGrid({
				...
				datatype: "json",
				 colModel: [
					...
					{label: 'source', name: 'source', width: 90},
					
					{label: 'PayMode', name: 'paymode', width: 90, classes: 'wrap', canSearch: true, checked:true,}, 
					
					{label: 'PayType', name: 'paytype', width: 90, editable:true,
					checked:true,  classes: 'wrap',},
					
					{label: 'Description', name: 'description', width: 200, canSearch: true, classes: 'wrap'}, 
					
					{label: 'Cost Code', name: 'ccode', width: 90, hidden: true}, 
					
					{label: 'GL Account', name: 'glaccno', width: 90, hidden: true},
					
					{label: 'Dr. Payment', name: 'drpayment', width: 90, hidden: true},
					
					{label: 'Record Status', name: 'recstatus', width: 90, hidden: true,},
					
					{label: 'Card Flag', name: 'cardflag', width: 90, hidden: true,},
					
					{label: 'ValExpDate', name: 'valexpdate', width: 90, hidden: true},
					
					{label: 'Entered By', name: 'lastuser', width: 200, hidden: true}, 
				],
