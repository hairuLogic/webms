		...
		$(document).ready(function () {
			...
			$("#dialogForm")
			  .dialog({ 
				...
				open: function( event, ui ) {
					...
					dialogHandler('finance.glmasref','depglacc',['glaccount','description'], 'Deposit GL Account');
					}
				},
			...
			$("#jqGrid").jqGrid('navGrid','#jqGridPager',
				...
				onClickButton: function(){
					...
					checkInput('finance.costcenter','depccode',['costcode','description'],$('#depccode').val());
					checkInput('finance.glmasref','depglacc',['glaccount','description'], $('#depglacc').val());
				}, 
				position: "first", 
