<?php
	...
	if(isset($_GET['Scol']) && $_GET['Stext'] != ''){
		...
		$SQL = "SELECT sysno, compcode, source, trantype, description, depccode, depglacc, 
				CASE WHEN updpayername = 1 THEN 'Yes' ELSE 'No' END AS updpayername,
				CASE WHEN updepisode = 1 THEN 'Yes' ELSE 'No' END AS  updepisode,
				CASE WHEN manualalloc = 1 THEN 'Yes' ELSE 'No' END AS manualalloc, 
				adduser, adddate, upduser, upddate, recstatus
				FROM $table 
