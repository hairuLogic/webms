		...
		$(document).ready(function () {
			...
			$("#dialogForm")
			  .dialog({ 
				...
				open: function( event, ui ) {
					emptyFormdata();
					dialogHandler('finance.costcenter','actdebccode',['costcode','description'],'Actual Cost');
					dialogHandler('finance.glmasref','actdebglacc',['glaccount','description'], 'Actual Account');
					dialogHandler('finance.costcenter','depccode',['costcode','description'], 'Deposit Cost');
					dialogHandler('finance.glmasref','depglacc',['glaccount','description'], 'Deposit Account');
				},
				buttons :butt1,
			  });
			...
			var urlParam={
				...
				field:['debtortycode','description','actdebccode','actdebglacc','depccode','depglacc'],
				except:'',
			...
			$("#jqGrid").jqGrid({
				...
				datatype: "json",
				 colModel: [
					{label: 'Financial Class', name: 'debtortycode', width: 90, canSearch:true },
