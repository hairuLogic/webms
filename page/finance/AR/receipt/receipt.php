...
<body>
	...
	<div id="tilldet" title="Select Till">
		<form class='form-horizontal' style='width:99%' id='formTillDet'>
			<div class="form-group">
				<label class="col-md-2 control-label" for="dept">Cashier</label>  
				<div class="col-md-10">
					<input id="cashier" name="cashier" type="text" class="form-control input-sm" data-validation="required" value="<?php echo $_SESSION['username'];?>">
				</div>
			</div>	
