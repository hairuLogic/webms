<?php
	...
	class ProfileModel
	{
		...
		function login_detail_check($usrid, $pwd, $company)
		{
			...
			// $sql.= "WHERE e_usrid='" . $usrid . "' AND e_pwd='" . $pwd . "' ";

			$sql = "SELECT a.groupid, a.username, a.compcode, b.bgpic, b.logo1, b.logo2, b.logo1width FROM sysdb.users a, sysdb.company b ";
			$sql.= "WHERE a.username='" . $usrid . "' AND a.password='" . $pwd . "' AND a.compcode='" . $company . "'";
