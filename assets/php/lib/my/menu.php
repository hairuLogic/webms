		...
		function create_sub_menu($rowX,$x,$class,$compcode)
		{
	        ...
	        {  	
				...
				if($class!='main')
				{
					$this->_menu_str .= "
					<li>
						<a href='#' aria-expanded='false' style='padding-left:".$this->tab($this->_x)."'>" .$rowX['programname'] ."<span class='fa plus-minus'></span></a>
				...
				else
				{
					$this->_menu_str .= "
					<li>
						<a href='#' aria-expanded='false' class='main' style='padding-left:".$this->tab($this->_x)."'><span class=' ionicon " .$rowX['condition3'] ."' style='padding-right:5px'></span>". $rowX['programname'] ."<span class='glyphicon arrow'></span></a>
						<ul aria-expanded='false'>";
				}
	        ...
	        else
	        {
				...
				$this->_menu_str .= "<li><a style='padding-left:".$this->tab($this->_x)."' title='".$rowX["programname"]."' class='clickable' programid='".$rowX["programid"]."' targetURL='page/".$rowX["url"]."'>".$rowX["programname"]."</a></li>"; 
	        }
